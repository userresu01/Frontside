        ...
        <div className={`min-h-screen ${th.page} transition-colors duration-500`}>
            ...
            <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-4 pb-10 pt-4 sm:px-6 lg:px-8 lg:pt-6">
                ...
                <main className="mt-6 flex flex-1 flex-col gap-20 pb-10 sm:mt-10 sm:gap-24 lg:gap-28">
                    ...
                    <Pricing t={t} neon={neon} motionConfig={motionConfig} darkMode={darkMode} />
                    ...
                    <Contact t={t} neon={neon} motionConfig={motionConfig} darkMode={darkMode} />
                </main>
...
function BackgroundGlow({ neon, darkMode }) {
    return (
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
            <div
                className={`absolute -top-36 -left-36 h-96 w-96 rounded-full blur-3xl ${darkMode ? neon.glowFrom : "bg-orange-400/40"
                    }`}
            />
            <div
                className={`absolute -bottom-44 -right-28 h-[28rem] w-[28rem] rounded-full blur-3xl ${darkMode ? neon.glowTo : "bg-fuchsia-500/45"
                    }`}
            />
            <div
                className={`absolute top-1/2 left-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl ${darkMode ? neon.glowMid : "bg-rose-400/38"
                    }`}
            />
            {!darkMode && (
        ...
        >
            <div className="relative z-10">
                <div className="flex items-center justify-between gap-4">
                    ...
                    >
                        <div className="relative">
                            ...
                            <div
                                className={`relative flex h-10 w-10 items-center justify-center rounded-xl ${darkMode ? "bg-slate-950" : "bg-white"
                                    }`}
                            >
                    ...
                    <nav
                        className={`hidden items-center gap-5 text-sm font-medium lg:flex ${darkMode ? "text-slate-200" : "text-slate-800"
                            }`}
                    >
                        {navItems.map((item) => (
                            <a
                                ...
                                className={`relative inline-flex items-center gap-1.5 text-[11px] uppercase tracking-[0.18em] transition ${darkMode
                    ...
                    <div className="flex items-center gap-2">
                        <a
                            ...
                            className={`hidden items-center gap-1.5 rounded-full border px-3 py-1 text-[11px] font-semibold shadow-sm transition hover:scale-105 md:inline-flex ${darkMode
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-9 w-9 items-center justify-center rounded-full border shadow-sm transition hover:scale-105 ${darkMode
                        ...
                        <button
                            className={`ml-1 inline-flex h-9 w-9 items-center justify-center rounded-full border transition lg:hidden ${darkMode
                ...
                <AnimatePresence>
                    {mobileNavOpen && (
                        <motion.nav
                            className={`mt-3 flex flex-col gap-2 rounded-xl border p-3 text-sm lg:hidden ${darkMode
                        ...
                        >
                            {navItems.map((item) => (
                                <a
                                    ...
                                    href={item.href}
                                    onClick={(e) => handleNavClick(e, item.href)}
                                    className={`rounded-lg px-2 py-1.5 text-xs uppercase tracking-[0.18em] transition ${darkMode
...
function LanguageSelector({ language, setLanguage, darkMode }) {
    ...
    return (
        <div
            className={`flex items-center gap-1.5 rounded-full border px-2 py-1 text-[11px] ${darkMode
        ...
        >
            ...
            {langs.map((lng) => (
                <button
                    ...
                    className={`rounded-full px-2 py-0.5 font-semibold transition ${language === lng
...
function Hero({ t, neon, motionConfig, darkMode, th }) {
    return (
        ...
        >
            ...
            >
                <div
                    className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-medium shadow ${darkMode
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <a
                        href="#contact"
                        className={`inline-flex items-center justify-center rounded-xl bg-gradient-to-r ${neon.primaryButtonGradient
                            } px-5 py-2.5 text-sm font-semibold text-slate-950 shadow-lg transition hover:scale-[1.02] ${darkMode ? "shadow-orange-500/40" : "shadow-orange-500/55"
                            }`}
                    >
                        {t("heroPrimary")}
                    </a>
                    ...
                    <a
                        href="#services"
                        className={`inline-flex items-center justify-center rounded-xl border px-4 py-2.5 text-sm font-medium shadow transition ${darkMode
            ...
            >
                <div className="relative w-full">
                    <div
                        className={`absolute -inset-1 rounded-3xl bg-gradient-to-br ${neon.heroGradient
                            } blur-xl opacity-90 ${darkMode ? "" : "opacity-100"}`}
                    />
                    <div
                        className={`relative rounded-3xl border p-4 shadow-xl ${darkMode
                    ...
                    >
                        <div className={`flex items-center justify-between text-xs ${th.textMuted2}`}>
                            ...
                            <span
                                className={`rounded-full px-2 py-0.5 text-[10px] uppercase tracking-[0.18em] ${darkMode ? "bg-slate-900/80 text-orange-200" : "bg-orange-50 text-orange-700"
                                    }`}
                            >
                                FRONTSIDE
                            </span>
...
function StatBadge({ label, darkMode }) {
    return (
        <div
            className={`inline-flex items-center gap-1 rounded-full border px-2.5 py-1 text-[11px] ${darkMode
...
function FakeCard({ icon, title, pill, darkMode }) {
    return (
        <div
            className={`flex items-center justify-between rounded-xl border px-3 py-2 text-xs ${darkMode
        ...
        >
            ...
            <span
                className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${darkMode ? "bg-orange-500/15 text-orange-200" : "bg-orange-100 text-orange-700"
                    }`}
            >
                {pill}
            </span>
        ...
        <section id="services" className="scroll-mt-24">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {items.map((item, idx) => (
                    <motion.div
                        key={item.title}
                        className={`group relative overflow-hidden rounded-2xl border p-4 shadow ${darkMode
                    ...
                    >
                        ...
                        <p className={`relative mt-3 text-xs leading-relaxed ${th.textMuted}`}>{item.desc}</p>
                    </motion.div>
                ))}
            </div>
        </section>
...
function Pricing({ t, motionConfig, darkMode }) {
    ...
    return (
        <section id="pricing" className="scroll-mt-24">
            ...
            <div
                className={`mx-auto mt-6 max-w-xl rounded-2xl border p-5 shadow-lg ${darkMode
        ...
        <section id="process" className="scroll-mt-24">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
                {steps.map((step, idx) => (
                    <motion.div
                        key={step.title}
                        className={`relative rounded-2xl border p-4 shadow ${darkMode
        ...
        <section id="showcase" className="scroll-mt-24">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
                {cards.map((card, idx) => (
                    <motion.div
                        key={card.title}
                        className={`group relative overflow-hidden rounded-2xl border p-4 shadow-lg ${darkMode
            ...
            <div className="mt-6 grid gap-3 lg:gap-4">
                {items.map((item, idx) => {
                    ...
                    return (
                        <motion.div
                            key={item.q}
                            className={`relative overflow-hidden rounded-2xl border p-0 shadow ${darkMode
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div
                                        className={`flex h-7 w-7 items-center justify-center rounded-full ${darkMode ? "bg-slate-900 text-orange-200" : "bg-orange-50 text-orange-700"
                                            }`}
                                    >
                                        <motion.span
                            ...
                            <AnimatePresence initial={false}>
                                {isOpen && (
                                    ...
                                    >
                                        <div
                                            className={`rounded-xl border px-3 py-2 text-xs leading-relaxed ${darkMode
        ...
        <section id="contact" className="scroll-mt-24">
            ...
            >
                <a
                    ...
                    className={`inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r ${neon.primaryButtonGradient
                        } px-5 py-2.5 text-sm font-semibold text-slate-950 shadow-lg transition hover:scale-[1.03] ${darkMode ? "shadow-orange-500/40" : "shadow-orange-500/55"
                        }`}
                >
...
function Footer({ t, neon, darkMode }) {
    ...
    return (
        <footer
            className={`mt-10 flex flex-col items-center gap-1 border-t pt-4 text-[11px] sm:flex-row sm:justify-between ${darkMode ? "border-slate-800/70 text-slate-500" : "border-orange-500/15 text-slate-600"
                }`}
        >
            <span>
